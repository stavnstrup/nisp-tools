...
<xsl:template name="book.titlepage.separator"><block break-after="page"/>
</xsl:template>

<xsl:template name="book.titlepage.before.recto">
</xsl:template>

<xsl:template name="book.titlepage.before.verso"><block break-after="page"/>
</xsl:template>
...
<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="book.titlepage.recto.style" text-align="center" font-size="14.4pt" space-before="10.8pt" font-weight="bold" font-family="{$title.font.family}">
...
<xsl:template name="dedication.titlepage.recto">
  <xsl:choose>
    <xsl:when test="dedicationinfo/title">
      <xsl:apply-templates mode="dedication.titlepage.recto.auto.mode" select="dedicationinfo/title"/>
    </xsl:when>
    <xsl:when test="docinfo/title">
      <xsl:apply-templates mode="dedication.titlepage.recto.auto.mode" select="docinfo/title"/>
    </xsl:when>
    <xsl:when test="title">
...
<xsl:template match="title" mode="dedication.titlepage.recto.auto.mode">
<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="dedication.titlepage.recto.style" force="1" margin-left="{$title.margin.left}" font-size="24.8832pt" font-family="{$title.font.family}" font-weight="bold">
...
<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="preface.titlepage.recto.style" force="1" margin-left="{$title.margin.left}" font-size="24.8832pt" font-family="{$title.font.family}" font-weight="bold">
<xsl:call-template name="component.title">
...
<xsl:template name="bibliography.titlepage.recto">
  <xsl:choose>
    <xsl:when test="bibliographyinfo/title">
      <xsl:apply-templates mode="bibliography.titlepage.recto.auto.mode" select="bibliographyinfo/title"/>
    </xsl:when>
    <xsl:when test="docinfo/title">
      <xsl:apply-templates mode="bibliography.titlepage.recto.auto.mode" select="docinfo/title"/>
    </xsl:when>
    <xsl:when test="title">
      <xsl:apply-templates mode="bibliography.titlepage.recto.auto.mode" select="title"/>
    </xsl:when>
  </xsl:choose>
...
<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="bibliography.titlepage.recto.style" force="1" margin-left="{$title.margin.left}" font-size="24.8832pt" font-family="{$title.font.family}" font-weight="bold">
<xsl:call-template name="component.title">
...
<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="glossary.titlepage.recto.style" force="1" margin-left="{$title.margin.left}" font-size="24.8832pt" font-family="{$title.font.family}" font-weight="bold">
<xsl:call-template name="component.title">
...
<xsl:template name="index.titlepage.recto">
  <xsl:choose>
    <xsl:when test="indexinfo/title">
      <xsl:apply-templates mode="index.titlepage.recto.auto.mode" select="indexinfo/title"/>
    </xsl:when>
    <xsl:when test="docinfo/title">
      <xsl:apply-templates mode="index.titlepage.recto.auto.mode" select="docinfo/title"/>
    </xsl:when>
    <xsl:when test="title">
      <xsl:apply-templates mode="index.titlepage.recto.auto.mode" select="title"/>
    </xsl:when>
  </xsl:choose>
...
<xsl:template match="title" mode="index.titlepage.recto.auto.mode">
<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="index.titlepage.recto.style" force="1" margin-left="{$title.margin.left}" font-size="24.8832pt" font-family="{$title.font.family}" font-weight="bold">
<xsl:call-template name="component.title">
...
<xsl:template name="colophon.titlepage.recto">
  <xsl:choose>
    <xsl:when test="colophoninfo/title">
      <xsl:apply-templates mode="colophon.titlepage.recto.auto.mode" select="colophoninfo/title"/>
    </xsl:when>
    <xsl:when test="docinfo/title">
      <xsl:apply-templates mode="colophon.titlepage.recto.auto.mode" select="docinfo/title"/>
    </xsl:when>
    <xsl:when test="title">
      <xsl:apply-templates mode="colophon.titlepage.recto.auto.mode" select="title"/>
    </xsl:when>
  </xsl:choose>
...
<xsl:template match="title" mode="colophon.titlepage.recto.auto.mode">
<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="colophon.titlepage.recto.style" force="1" margin-left="{$title.margin.left}" font-size="24.8832pt" font-family="{$title.font.family}" font-weight="bold">
<xsl:call-template name="component.title">
...
<xsl:template name="table.of.contents.titlepage.recto">
  <xsl:choose>
    <xsl:when test="table.of.contentsinfo/title">
      <xsl:apply-templates mode="table.of.contents.titlepage.recto.auto.mode" select="table.of.contentsinfo/title"/>
    </xsl:when>
    <xsl:when test="docinfo/title">
      <xsl:apply-templates mode="table.of.contents.titlepage.recto.auto.mode" select="docinfo/title"/>
    </xsl:when>
    <xsl:when test="title">
      <xsl:apply-templates mode="table.of.contents.titlepage.recto.auto.mode" select="title"/>
    </xsl:when>
  </xsl:choose>
...
<xsl:template match="title" mode="table.of.contents.titlepage.recto.auto.mode">
<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="table.of.contents.titlepage.recto.style" force="1" space-before.minimum="1em" space-before.optimum="1.5em" space-before.maximum="2em" space-after="0.5em" margin-left="{$title.margin.left}" font-size="17.28pt" font-weight="bold" font-family="{$title.font.family}">
...
<xsl:template name="list.of.tables.titlepage.recto">
  <xsl:choose>
    <xsl:when test="list.of.tablesinfo/title">
      <xsl:apply-templates mode="list.of.tables.titlepage.recto.auto.mode" select="list.of.tablesinfo/title"/>
    </xsl:when>
    <xsl:when test="docinfo/title">
      <xsl:apply-templates mode="list.of.tables.titlepage.recto.auto.mode" select="docinfo/title"/>
    </xsl:when>
    <xsl:when test="title">
      <xsl:apply-templates mode="list.of.tables.titlepage.recto.auto.mode" select="title"/>
    </xsl:when>
  </xsl:choose>
...
<xsl:template match="title" mode="list.of.tables.titlepage.recto.auto.mode">
<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="list.of.tables.titlepage.recto.style" force="1" space-after="1em" margin-left="{$title.margin.left}" font-size="17.28pt" font-weight="bold" font-family="{$title.font.family}">
<xsl:call-template name="gentext">
...
<xsl:template name="list.of.figures.titlepage.recto">
  <xsl:choose>
    <xsl:when test="list.of.figuresinfo/title">
      <xsl:apply-templates mode="list.of.figures.titlepage.recto.auto.mode" select="list.of.figuresinfo/title"/>
    </xsl:when>
    <xsl:when test="docinfo/title">
      <xsl:apply-templates mode="list.of.figures.titlepage.recto.auto.mode" select="docinfo/title"/>
    </xsl:when>
    <xsl:when test="title">
      <xsl:apply-templates mode="list.of.figures.titlepage.recto.auto.mode" select="title"/>
    </xsl:when>
  </xsl:choose>
...
<xsl:template match="title" mode="list.of.figures.titlepage.recto.auto.mode">
<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="list.of.figures.titlepage.recto.style" force="1" space-before.minimum="1em" space-before.optimum="1.5em" space-before.maximum="2em" space-after="0.5em" margin-left="{$title.margin.left}" font-size="17.28pt" font-weight="bold" font-family="{$title.font.family}">
<xsl:call-template name="gentext">
...
<xsl:template name="list.of.examples.titlepage.recto">
  <xsl:choose>
    <xsl:when test="list.of.examplesinfo/title">
      <xsl:apply-templates mode="list.of.examples.titlepage.recto.auto.mode" select="list.of.examplesinfo/title"/>
    </xsl:when>
    <xsl:when test="docinfo/title">
      <xsl:apply-templates mode="list.of.examples.titlepage.recto.auto.mode" select="docinfo/title"/>
    </xsl:when>
    <xsl:when test="title">
      <xsl:apply-templates mode="list.of.examples.titlepage.recto.auto.mode" select="title"/>
    </xsl:when>
  </xsl:choose>
...
<xsl:template match="title" mode="list.of.examples.titlepage.recto.auto.mode">
<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="list.of.examples.titlepage.recto.style" force="1" space-before.minimum="1em" space-before.optimum="1.5em" space-before.maximum="2em" space-after="0.5em" margin-left="{$title.margin.left}" font-size="17.28pt" font-weight="bold" font-family="{$title.font.family}">
<xsl:call-template name="gentext">
...
<xsl:template name="list.of.equations.titlepage.recto">
  <xsl:choose>
    <xsl:when test="list.of.equationsinfo/title">
      <xsl:apply-templates mode="list.of.equations.titlepage.recto.auto.mode" select="list.of.equationsinfo/title"/>
    </xsl:when>
    <xsl:when test="docinfo/title">
      <xsl:apply-templates mode="list.of.equations.titlepage.recto.auto.mode" select="docinfo/title"/>
    </xsl:when>
    <xsl:when test="title">
      <xsl:apply-templates mode="list.of.equations.titlepage.recto.auto.mode" select="title"/>
    </xsl:when>
  </xsl:choose>
...
<xsl:template match="title" mode="list.of.equations.titlepage.recto.auto.mode">
<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="list.of.equations.titlepage.recto.style" force="1" space-before.minimum="1em" space-before.optimum="1.5em" space-before.maximum="2em" space-after="0.5em" margin-left="{$title.margin.left}" font-size="17.28pt" font-weight="bold" font-family="{$title.font.family}">
<xsl:call-template name="gentext">
...
<xsl:template name="list.of.unknowns.titlepage.recto">
  <xsl:choose>
    <xsl:when test="list.of.unknownsinfo/title">
      <xsl:apply-templates mode="list.of.unknowns.titlepage.recto.auto.mode" select="list.of.unknownsinfo/title"/>
    </xsl:when>
    <xsl:when test="docinfo/title">
      <xsl:apply-templates mode="list.of.unknowns.titlepage.recto.auto.mode" select="docinfo/title"/>
    </xsl:when>
    <xsl:when test="title">
      <xsl:apply-templates mode="list.of.unknowns.titlepage.recto.auto.mode" select="title"/>
    </xsl:when>
  </xsl:choose>
...
<xsl:template match="title" mode="list.of.unknowns.titlepage.recto.auto.mode">
<fo:block xmlns:fo="http://www.w3.org/1999/XSL/Format" xsl:use-attribute-sets="list.of.unknowns.titlepage.recto.style" force="1" space-before.minimum="1em" space-before.optimum="1.5em" space-before.maximum="2em" space-after="0.5em" margin-left="{$title.margin.left}" font-size="17.28pt" font-weight="bold" font-family="{$title.font.family}">
<xsl:call-template name="gentext">
